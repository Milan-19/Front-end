        ...
        <VStack spacing={3} align="stretch">
          {groups.map((group) => (
            <Box
              ...
              cursor="pointer"
              borderRadius="lg"
              bg={usersGroups.includes(group?._id) ? "blue.50" : "gray.50"}
              borderWidth="1px"
              borderColor={
                usersGroups.includes(group?._id) ? "blue.200" : "gray.200"
              }
              transition="all 0.2s"
              _hover={{
            ...
            >
              <Flex justify="space-between" align="center">
                <Box
                  onClick={() =>
                    usersGroups.includes(group?._id) && setSelectedGroup(group)
                  }
                  flex="1"
                >
                  <Flex align="center" mb={2}>
                    ...
                    {usersGroups.includes(group._id) && (
                ...
                <Button
                  size="sm"
                  colorScheme={
                    usersGroups?.includes(group?._id) ? "red" : "blue"
                  }
                  variant={
                    usersGroups?.includes(group?._id) ? "ghost" : "solid"
                  }
                  ml={3}
                  onClick={() => {
                    usersGroups?.includes(group?._id)
